...
const TABS = [
  ...
  { key: 'yields', label: '💧 Yield Farming', content: YieldsPageContent },
  { key: 'sectors', label: '📊 Sector Flows', content: SectorsPageContent },
  { key: 'revenue', label: '💰 Revenue', content: RevenuePageContent },
] as const
