"use strict";
(self["webpackChunknexus_promo"] = self["webpackChunknexus_promo"] || []).push([[179],{
...
var sample = __webpack_require__(4166);
...
const validateVideoOptions = (videoOptions) => {
    ...
    if (videoOptions?.crop !== undefined) {
        (0,sample/* validateCropRectangle */.wS)(videoOptions.crop, 'options.video.');
    }
...
class Conversion {
    ...
    async _processVideoTrack(track, trackOptions, outputTrackId) {
        ...
        if (crop) {
            crop = (0,sample/* clampCropRectangle */.px)(crop, rotatedWidth, rotatedHeight);
        }
        ...
        if (!trackOptions.forceTranscode
            ...
            this._trackPromises.push((async () => {
                ...
                if (needsPadding) {
                    ...
                    const silentSample = new sample/* AudioSample */.B1({
